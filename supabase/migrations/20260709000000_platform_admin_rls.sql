...
-- RLS policies call is_platform_admin() as the table owner / invoker; authenticated needs EXECUTE.
...
-- is_staff_member: designated platform admin, not any admin role
...
-- Bootstrap platform_admin_user_id from the first active admin if unset
